...
#-------------------------------------------------------------------------------------
def run(cutadaptDir,tagNameUmiSeq,tagNamePrimer,tagNamePrimerErr,primerFasta,primer3Bases,filePrefix,primerFile):
    ...
    fileIn1 = filePrefix + ".temp1.R1.fastq"
    fileIn2 = filePrefix + ".temp1.R2.fastq"
    fileOut1 = filePrefix + ".temp2.R1.fastq"
    fileOut2 = filePrefix + ".temp2.R2.fastq"   
    primer_trim.main(fileIn1,fileIn2,fileOut1,fileOut2,primerFile,primerFile+'.clusters',int(primer3Bases),tagNamePrimer,tagNamePrimerErr)
    print "Done primer trimming...\n"
    ...
    os.rename(filePrefix + ".temp2.R1.fastq", filePrefix + ".R1.fastq")
...
if __name__ == "__main__":
    ...
    run(cutadaptDir,tagNameUmiSeq,tagNamePrimer,tagNamePrimerErr,primerFasta,primer3Bases,readFilePrefix,primerFile)
